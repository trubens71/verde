...
% === Channel rankings \xc3\xa0 la APT ===
...
cardinality("Net_Total_Expenditure_x1000", 152).
fieldtype("Gross_Total_Expenditure_x1000",number).
cardinality("Gross_Total_Expenditure_x1000", 152).
fieldtype("Gross_Current_Expenditure_x1000",number).
cardinality("Gross_Current_Expenditure_x1000", 152).
fieldtype("Number_of_requests_for_support_received_from_new_clients_18_to_64",number).
cardinality("Number_of_requests_for_support_received_from_new_clients_18_to_64", 149).
fieldtype("Number_of_requests_for_support_received_from_new_clients_65_and_over",number).
cardinality("Number_of_requests_for_support_received_from_new_clients_65_and_over", 148).
fieldtype("New_clients_with_an_episode_of_ST_Max_care_and_a_known_sequel_18_to_64",number).
cardinality("New_clients_with_an_episode_of_ST_Max_care_and_a_known_sequel_18_to_64", 67).
fieldtype("New_clients_with_an_episode_of_ST_Max_care_and_a_known_sequel_65_and_over",number).
cardinality("New_clients_with_an_episode_of_ST_Max_care_and_a_known_sequel_65_and_over", 127).
fieldtype("Long_Term_Support_during_the_year_18_to_64",number).
cardinality("Long_Term_Support_during_the_year_18_to_64", 136).
fieldtype("Long_Term_Support_during_the_year_65_and_over",number).
cardinality("Long_Term_Support_during_the_year_65_and_over", 142).
fieldtype("Support_provided_to_carers_during_the_year",number).
cardinality("Support_provided_to_carers_during_the_year", 146).
fieldtype("Social_care_related_quality_of_life_score_All",number).
cardinality("Social_care_related_quality_of_life_score_All", 26).
fieldtype("Social_care_related_quality_of_life_score_Male",number).
cardinality("Social_care_related_quality_of_life_score_Male", 28).
fieldtype("Social_care_related_quality_of_life_score_Female",number).
cardinality("Social_care_related_quality_of_life_score_Female", 28).
fieldtype("Social_care_related_quality_of_life_score_18_to_64",number).
cardinality("Social_care_related_quality_of_life_score_18_to_64", 30).
fieldtype("Social_care_related_quality_of_life_score_65_and_over",number).
cardinality("Social_care_related_quality_of_life_score_65_and_over", 28).

data("data/AFR_T1_ASCOF_1A_colfix.json").
encoding(e0).
field(e0,"Social_care_related_quality_of_life_score_All").
encoding(e1).
field(e1,"Gross_Total_Expenditure_x1000").

% Verde rule 1: x/y encoding preferences
% for encoding pair 0 prefer x=field.e1.Gross_Total_Expenditure_x1000 y=field.e0.Social_care_related_quality_of_life_score_All
soft(e0_e1) :- channel(e0,x), not channel(e0,y), channel(e1,y), not channel(e1,x).
#const e0_e1_weight = 1.
soft_weight(e0_e1,e0_e1_weight).
